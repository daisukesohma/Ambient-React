...
const PlaybackControls = ({
  ...
  const readableDateTS = useSelector(getReadableDateTS({ videoStreamKey }))
  ...
  return (
    ...
    >
      ...
      <div className='playback-controls-v1 playback-component-progressbar'>
        <Timeline videoStreamKey={videoStreamKey} />
        <TimelineScroll videoStreamKey={videoStreamKey} />
      </div>
      ...
      <div className='playback-controls-v1 playback-component-bigger playback-controls-end'>
        ...
        <LiveIncidentButton videoStreamKey={videoStreamKey} />
