...
const Federation = ({ identitySourceId, profileId, updateFederation }) => {
          ...
          <div className={classes.listContainer}>
            ...
            <div className={classes.list}>
              {federations.map((federation, index) => {
                const isSelected = selected.includes(federation.id)
                return (
                  <div
                    ...
                    style={
                      isSelected ? { backgroundColor: palette.primary[50] } : {}
                    }
                  >
