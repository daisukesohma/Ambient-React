...
export class StreamSourceInfo {
  ...
  constructor(audioSourceInfo, videoSourceInfo) {
    if (
      !isAllowedValue(audioSourceInfo, [
        undefined,
        'mic',
        'screen-cast',
        'file',
    ...
    if (
      !isAllowedValue(videoSourceInfo, [
        undefined,
        'camera',
        'screen-cast',
        'file',
  ...
  constructor(id, origin, stream, sourceInfo, attributes) {
    ...
    stream.onremovetrack = e => {
      ...
      if (!e.currentTarget.active) {
        const streamEvent = new StreamEvent('ended', {
          stream: e.currentTarget,
        })
...
export class StreamEvent extends OwtEvent {
  ...
  constructor(type, init) {
    ...
    /**
     * @member {RTCRtpReceiver} receiver
     * @instance
     * @memberof Owt.Base.StreamEvent
     */
