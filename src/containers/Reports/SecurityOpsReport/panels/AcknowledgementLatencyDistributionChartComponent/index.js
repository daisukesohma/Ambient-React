...
const AcknowledgementDistributionChartComponent = ({
  pollInterval,
  isTest,
  severities,
}) => {
  ...
  const title = 'Time to Resolve Alert (mins)'
  ...
  const dataArr = map(
    get(source, 'acknowledgementLatencyDistribution', []),
    timeRange => ({
...
AcknowledgementDistributionChartComponent.defaultProps = {
  pollInterval: null,
  isTest: false,
  severities: [],
}

AcknowledgementDistributionChartComponent.propTypes = {
  pollInterval: PropTypes.number,
  isTest: PropTypes.bool,
  severities: PropTypes.array,
}

export default AcknowledgementDistributionChartComponent
